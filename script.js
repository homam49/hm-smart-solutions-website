...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Simple Netlify Forms with AJAX
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            .then(() => {
                ...
                formContainer.innerHTML = `
                    <div style="text-align: center; padding: 2rem; background: #d4edda; border: 2px solid #28a745; border-radius: 8px; color: #155724;">
                        ...
                        <button onclick="location.reload()" class="btn btn-primary" style="margin-top: 1rem;">Send Another Inquiry</button>
                    </div>
                `;
            })
            .catch(() => {
